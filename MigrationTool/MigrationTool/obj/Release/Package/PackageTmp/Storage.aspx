...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table align="center" style="border: none;" width="100%">
        <tr>
            <td style="text-align: left"><div class="header2">Storage</div></td>
    ...
    <asp:Panel ID="pnlpopup" runat="server" BackColor="White" CssClass="Popup" Height="95%" Width="700px" Style="display: none">
        <table width="100%" style="border: Solid 3px #D55500; width: 100%; height: 100%" cellpadding="2" cellspacing="2">
            <tr style="background-color: #D55500">
                <td colspan="2" style="height: 5%; color: White; font-weight: bold; font-size: larger" align="center">Storage Details</td>
            </tr>
            <tr>
                <td align="right" width="40%">Storage Name:
                </td>
                <td>
                    <asp:Label ID="lblStorageName" runat="server" Font-Bold="true"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="right">Type:
                ...
                <td>
                    <asp:TextBox ID="txtType" runat="server" CssClass="textbox2" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right">Storage Capacity Allocated - GB:
                </td>
                <td>
                    <asp:TextBox ID="txtStorageCapacityAllocated" runat="server" CssClass="textbox2" />
                </td>
            </tr>
            <tr>
                <td align="right">Storage Capacity Used - GB:
                </td>
                <td>
                    <asp:TextBox ID="txtStorageCapacityUsed" runat="server" CssClass="textbox2" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtSecondaryTechContact" runat="server" CssClass="textbox2" />
                </td>
            </tr>
            <tr>
    ...
    <asp:Panel ID="pnlpopup1" runat="server" BackColor="White" CssClass="Popup" Height="200px" Width="400px" Style="display: none">
        <table width="100%" style="border: Solid 3px #D55500; width: 100%; height: 100%" cellpadding="2" cellspacing="2">
            <tr style="background-color: #D55500">
                <td colspan="2" style="height: 5%; color: White; font-weight: bold; font-size: larger" align="center">Delete Storage</td>
            </tr>
            <tr>
                <td style="text-align: center">Are you sure to delete the Storage - <br />
                    <asp:Label ID="lblStorage" runat="server" Font-Bold="true"></asp:Label>?
                </td>
                <td></td>
            </tr>
            <tr>
